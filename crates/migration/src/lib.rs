...
mod m20230629_000001_alter_projectinfo;
mod m20230629_000002_alter_projectdeployment;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20230629_000001_alter_projectinfo::Migration),
            Box::new(m20230629_000002_alter_projectdeployment::Migration),
        ]
    }
}
