...
pub mod land {
    ...
    pub mod http {
        ...
        pub mod body {
            ...
            pub fn read(handle: BodyHandle, size: u32) -> Result<(_rt::Vec<u8>, bool), BodyError> {
                unsafe {
                    #[repr(align(4))]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.26.0:http-service-with-all-of-its-exports-removed:encoded world"]
#[doc(hidden)]
...
it-component\x070.209.1\x10wit-bindgen-rust\x060.26.0";
