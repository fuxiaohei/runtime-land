...
macro_rules! __export_http_handler_impl {
  ...
  const _: () = {
    ...
    #[cfg(target_arch = "wasm32")]
    #[link_section = "component-type:wit-bindgen:0.21.0:http-handler:imports and exports"]
    #[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:http-handler-with-all-of-its-exports-removed:encoded world"]
#[doc(hidden)]
