...
pub mod exports {
    ...
    pub mod land {
        ...
        pub mod http {
            ...
            pub mod incoming {
                ...
                pub unsafe fn _export_handle_request_cabi<T: Guest>(
                    ...
                    let result9 =
                        T::handle_request(super::super::super::super::land::http::types::Request {
                    ...
                    *ptr10.add(0).cast::<u16>() = (_rt::as_i32(status11)) as u16;
                    ...
                    let len15 = vec15.len();
                    let layout15 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec15.len() * 16, 4);
        ...
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          unsafe extern "C" fn export_handle_request(arg0: *mut u8,arg1: usize,arg2: *mut u8,arg3: usize,arg4: *mut u8,arg5: usize,arg6: i32,arg7: i32,) -> *mut u8 {
            $($path_to_types)*::_export_handle_request_cabi::<$ty>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7)
          }
...
macro_rules! __export_http_handler_impl {
  ...
  $($path_to_types_root)*::exports::land::http::incoming::__export_land_http_incoming_cabi!($ty with_types_in $($path_to_types_root)*::exports::land::http::incoming);
  const _: () = {

    #[cfg(target_arch = "wasm32")]
    #[link_section = "component-type:wit-bindgen:0.26.0:http-handler:imports and exports"]
    #[doc(hidden)]
...
producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.209.1\x10wit-bindgen-rus\
t\x060.26.0";
  };
  )
}
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.26.0:http-handler-with-all-of-its-exports-removed:encoded world"]
#[doc(hidden)]
...
ssed-by\x02\x0dwit-component\x070.209.1\x10wit-bindgen-rust\x060.26.0";
