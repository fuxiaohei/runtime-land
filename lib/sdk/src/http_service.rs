...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.27.0:http-service-with-all-of-its-exports-removed:encoded world"]
#[doc(hidden)]
...
rs\x01\x0cprocessed-by\x02\x0dwit-component\x070.212.0\x10wit-bindgen-rust\x060.\
27.0";
#[inline(never)]
#[doc(hidden)]
#[cfg(target_arch = "wasm32")]
