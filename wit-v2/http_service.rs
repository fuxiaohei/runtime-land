...
pub mod moni {
    pub mod http {
        ...
        pub mod http_body {
            ...
            pub type HttpBodyHandle = super::super::super::moni::http::http_types::HttpBodyHandle;
            ...
            pub fn http_body_read(
                ...
                unsafe {
                    ...
                    #[link(wasm_import_module = "moni:http/http-body")]
                    extern "C" {
                        #[cfg_attr(target_arch = "wasm32", link_name = "http-body-read")]
                        #[cfg_attr(
                            not(target_arch = "wasm32"),
                            link_name = "moni:http/http-body_http-body-read"
                        )]
            ...
            pub fn http_body_read_all(
                ...
                unsafe {
                    ...
                    extern "C" {
                        ...
                        #[cfg_attr(
                            not(target_arch = "wasm32"),
                            link_name = "moni:http/http-body_http-body-read-all"
                        )]
                        fn wit_import(_: i32, _: i32);
                    }
                    wit_import(wit_bindgen::rt::as_i32(handle), ptr0);
            ...
            pub fn http_body_write(handle: HttpBodyHandle, data: &[u8]) -> Result<u64, BodyError> {
                ...
                unsafe {
                    ...
                    extern "C" {
                        ...
                        #[cfg_attr(
                            not(target_arch = "wasm32"),
                            link_name = "moni:http/http-body_http-body-write"
                        )]
            ...
            pub fn http_body_new() -> Result<HttpBodyHandle, BodyError> {
                ...
                unsafe {
                    ...
                    extern "C" {
                        ...
                        #[cfg_attr(
                            not(target_arch = "wasm32"),
                            link_name = "moni:http/http-body_http-body-new"
                        )]
                        fn wit_import(_: i32);
                    }
                    wit_import(ptr0);
            ...
            pub fn http_body_new_stream() -> Result<HttpBodyHandle, BodyError> {
                ...
                unsafe {
                    ...
                    extern "C" {
                        ...
                        #[cfg_attr(
                            not(target_arch = "wasm32"),
                            link_name = "moni:http/http-body_http-body-new-stream"
                        )]
                        fn wit_import(_: i32);
                    }
                    wit_import(ptr0);
        ...
        pub mod http_outgoing {
            ...
            pub type Request<'a> = &'a super::super::super::moni::http::http_types::Request;
            pub type Response = super::super::super::moni::http::http_types::Response;
            pub type RequestError = super::super::super::moni::http::http_types::RequestError;
            pub type RequestOptions = super::super::super::moni::http::http_types::RequestOptions;
            #[allow(clippy::all)]
            pub fn fetch_request(
                ...
                unsafe {
                    ...
                    struct RetArea([u8; 24]);
                    let mut ret_area = ::core::mem::MaybeUninit::<RetArea>::uninit();
                    let super::super::super::moni::http::http_types::Request {
                        method: method0,
                        uri: uri0,
                        headers: headers0,
                        body: body0,
                    ...
                    let super::super::super::moni::http::http_types::RequestOptions {
                        timeout: timeout8,
                        redirect: redirect8,
                    } = options;
                    let ptr9 = ret_area.as_mut_ptr() as i32;
                    #[link(wasm_import_module = "moni:http/http-outgoing")]
                    extern "C" {
                        #[cfg_attr(target_arch = "wasm32", link_name = "fetch-request")]
                        #[cfg_attr(
                            not(target_arch = "wasm32"),
                            link_name = "moni:http/http-outgoing_fetch-request"
                        )]
                        fn wit_import(
                            _: i32,
                            _: i32,
                    ...
                    wit_import(
                        ...
                        match redirect8 {
                            super::super::super::moni::http::http_types::RedirectPolicy::Follow => {
                                0
                            }
                            super::super::super::moni::http::http_types::RedirectPolicy::Error => 1,
                            super::super::super::moni::http::http_types::RedirectPolicy::Manual => {
                                2
                            }
                        },
                        ptr9,
                    ...
                    match i32::from(*((ptr9 + 0) as *const u8)) {
                        0 => Ok({
                            ...
                            super::super::super::moni::http::http_types::Response {
                    ...
                    0 => super::super::super::moni::http::http_types::RequestError::NetworkError,
                    1 => super::super::super::moni::http::http_types::RequestError::Timeout,
                    2 => super::super::super::moni::http::http_types::RequestError::InvalidUrl,
                    3 => super::super::super::moni::http::http_types::RequestError::DestinationNotAllowed,
                    4 => super::super::super::moni::http::http_types::RequestError::TooManyRequests,
                    5 => super::super::super::moni::http::http_types::RequestError::InvalidRequest,
                    _ => panic!("invalid enum discriminant"),
                  }
                            }
                            #[cfg(not(debug_assertions))]
                            {
                                ::core::mem::transmute::<
                                    _,
                                    super::super::super::moni::http::http_types::RequestError,
                                >(i32::from(
                                    *((ptr9 + 4) as *const u8),
                                )
                                    as u8)
